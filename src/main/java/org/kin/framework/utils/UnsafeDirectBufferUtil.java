...
public final class UnsafeDirectBufferUtil {
    private static final Logger log = LoggerFactory.getLogger(UnsafeDirectBufferUtil.class);
    ...
    static {
        ...
        try {
            ...
            if (log.isWarnEnabled()) {
                log.warn("java.nio.Bits: unavailable, {}.", ExceptionUtils.getExceptionDesc(t));
            }
